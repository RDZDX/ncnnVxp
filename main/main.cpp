...
static const VMWCHAR class_names_w[10][8] = {
    { 'p','l','a','n','e',0 },
    { 'c','a','r',0 },
    { 'b','i','r','d',0 },
    { 'c','a','t',0 },
...
static const VMWCHAR rank1_w[] = { '1','.', ' ', 0 };
static const VMWCHAR rank2_w[] = { '2','.', ' ', 0 };
static const VMWCHAR rank3_w[] = { '3','.', ' ', 0 };
static const VMWCHAR space_w[] = { ' ', 0 };
static const VMWCHAR percent_w[] = { '%', 0 };
...
//        unsigned char b = (p & 0x1F) << 3;
        ...
        unsigned char r = (unsigned char)((((p >> 11) & 0x1F) * 255) / 31); //this variant better ?
...
void draw_top_class_line_ucs2(int rank, int top_index, int y)
{
    ...
    /*
       Pad class name to fixed width.
       Longest class name is 5 chars.
       Add spaces so "car" does not look visually strange.
    */
